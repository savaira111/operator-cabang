...
class ZiMonitoringSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $ss1_1 = ZiMonitoring::create([
            'cabang_id' => null, 'tahun' => 2026,
            'parent_id' => null, 'tahun' => 2026,
            'tipe' => 'SS2',
            'nomor' => 'SS.1.1',
        ...
        ZiMonitoring::create([
            ...
            'target_output' => '1',
            'waktu_pelaksanaan' => 'BO3,BO6,BO9,B12',
        ...
        ZiMonitoring::create([
            ...
            'pelaksana' => 'Kanwil Ditjen Pemasyarakatan',
            'koordinator' => 'BIRO PERENCANAAN DAN KEUANGAN',
            'data_dukung' => 'Dokumen MR sesuai pedoman menteri imigrasi dan pemasyarakatan M.POT.02.02-67 Tahun 2026; piagam MR; dokumen penanganan risiko pelayanan publik dan integritas',
            'status_data_dukung' => 'belum_ada',
            'prosentase' => 0,
        ]);
        ...
        ZiMonitoring::create([
            ...
            'tipe' => 'IO',
            'nomor' => 'IO.20.5',
            'rincian_kegiatan' => 'Evaluasi hasil pelaksanaan SPAK-SPKP/SKM tahun 2026',
        ...
        // Create dummy files for BO3 for branch items
        $branchItems = ZiMonitoring::where('tipe', 'IO')
            ->where('waktu_pelaksanaan', 'LIKE', '%BO3%')
            ->get();

        foreach ($branchItems as $item) {
            \App\Models\ZiMonitoringFile::create([
                'zi_monitoring_id' => $item->id,
                'period' => 'BO3',
                'file_path' => 'dummy_bo3.pdf',
                'status' => 'menunggu',
                'catatan' => 'Data dummy seeder'
            ]);
            
            // Also update the monitoring status
            $item->update([
