...
@section('title', 'Edit Rencana Kegiatan Belum Terealisasi')
@section('page_title', 'Edit Rencana')

@section('content')
<div class="w-full bg-[#111827] border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl">
    <div class="mb-10 flex items-start justify-between">
        <div>
            <h3 class="text-2xl font-black text-white tracking-tight">Edit Rencana Kegiatan Belum Terealisasi</h3>
            <p class="text-slate-500 text-sm mt-1">Perbarui keterangan realisasi rencana.</p>
        </div>
