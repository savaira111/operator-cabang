        ...
        <form action="{{ route('zis.store') }}" method="POST" class="relative z-10">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3" for="bulan">Bulan (B03-B12)</label>
                        <select name="bulan" id="bulan" class="w-full bg-[#061B30] border border-slate-800 text-white text-sm rounded-2xl focus:ring-4 focus:ring-[#D2A039]/10 focus:border-[#D2A039] block p-4">
                            <option value="B03" {{ old('bulan') == 'B03' ? 'selected' : '' }}>B03 (Maret)</option>
                            <option value="B06" {{ old('bulan') == 'B06' ? 'selected' : '' }}>B06 (Juni)</option>
                            <option value="B09" {{ old('bulan') == 'B09' ? 'selected' : '' }}>B09 (September)</option>
                            <option value="B12" {{ old('bulan') == 'B12' ? 'selected' : '' }}>B12 (Desember)</option>
                        </select>
