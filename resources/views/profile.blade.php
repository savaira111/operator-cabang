...
@section('content')
<div class="w-full">
    <div class="bg-[#111827] border border-slate-800 rounded-[2.5rem] p-12 shadow-2xl relative overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-12 relative z-10">
            <div class="w-48 h-48 rounded-[3rem] bg-gradient-to-br from-indigo-500/20 to-blue-500/20 p-1 border border-slate-700/50 shadow-2xl group overflow-hidden">
                <div class="w-full h-full bg-[#0a0f1c] rounded-[2.8rem] flex items-center justify-center border border-slate-800 transition-all duration-500 group-hover:scale-110">
                    <i data-lucide="user" class="w-20 h-20 text-indigo-400 group-hover:text-blue-400"></i>
                </div>
            </div>
            
            <div class="flex-1 text-center md:text-left">
                <div class="mb-6">
                    <span class="inline-flex px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-4">
                ...
                <div class="flex flex-wrap items-center justify-center md:justify-start gap-4">
                    <div class="px-6 py-3 bg-slate-800/50 rounded-2xl border border-slate-700 flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 border-t border-slate-800 pt-16">
            <div class="bg-slate-800/20 p-8 rounded-3xl border border-slate-800/50">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between border-t border-slate-800/50 pt-4">
                        ...
                        <div class="flex space-x-1">
                            @for($i=0; $i<5; $i++)
                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-500/60 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></div>
                            @endfor
                        </div>
                    </div>
                    <div class="flex items-center justify-between border-t border-slate-800/50 pt-4">
                        <span class="text-sm font-medium text-slate-500">Assigned Branch</span>
                        <span class="text-sm font-black text-indigo-400 tracking-tighter uppercase whitespace-nowrap">KANTOR PUSAT CANARY</span>
                    </div>
                </div>
            </div>

            <div class="bg-slate-800/20 p-8 rounded-3xl border border-slate-800/50 flex flex-col justify-between">
                <div>
                ...
                <button class="w-full py-4 bg-indigo-500 hover:bg-indigo-600 text-white font-black rounded-2xl transition-all shadow-xl shadow-indigo-500/20 active:scale-95 text-xs uppercase tracking-widest">
                    Update Security
                </button>
            </div>
        </div>
