...
<div class="w-full bg-[#111827] border border-slate-800 rounded-2xl p-10 shadow-2xl">
    <div class="mb-10 relative z-10">
        ...
        <a href="{{ route('cabangs.index') }}" class="flex items-center justify-center w-full px-6 py-4 bg-slate-800/50 hover:bg-rose-500/10 text-slate-400 hover:text-rose-400 font-bold rounded-2xl border border-slate-700/50 transition-all active:scale-95 group">
