    ...
    <div class="bg-[#111827] border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden">
        ...
        <div class="mb-10 flex items-center justify-between relative z-10">
            <div class="flex items-center gap-6">
                <a href="{{ route('cabangs.index') }}" class="p-3.5 bg-slate-800/50 hover:bg-blue-500/10 text-slate-400 hover:text-blue-400 rounded-2xl border border-slate-700/50 transition-all active:scale-95 group" title="Kembali">
            ...
            <a href="{{ route('cabangs.edit', $cabang) }}" class="flex items-center px-6 py-3 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-2xl transition-all active:scale-95 shadow-lg shadow-indigo-500/20">
                ...
                <span class="text-xs uppercase tracking-widest">Ubah Cabang</span>
            </a>
        </div>
