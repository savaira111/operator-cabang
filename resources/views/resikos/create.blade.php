...
@section('title', 'Identifikasi Resiko')
@section('page_title', 'Identifikasi Resiko Baru')

@section('content')
<div class="w-full bg-[#111827] border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl">
    <div class="mb-10 flex items-start justify-between">
        <div>
            <h3 class="text-2xl font-black text-white tracking-tight">Identifikasi Resiko</h3>
            <p class="text-slate-500 text-sm mt-1">Gunakan formulir ini untuk melaporkan potensi resiko operasional.</p>
        </div>
    ...
    <form action="{{ route('resikos.store') }}" method="POST">
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="w-full px-5 py-4 bg-slate-800/50 rounded-2xl border border-slate-700 text-white focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all outline-none resize-none" placeholder="Jelaskan dampak dan mitigasi resiko ini..."></textarea>
            </div>
