    ...
    <form action="{{ route('reviu-usulan.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="usulan_pernyataan_risiko" rows="4" required class="w-full px-5 py-4 bg-slate-800/50 rounded-2xl border border-slate-700 text-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none resize-none" placeholder="Tuliskan usulan pernyataan risiko baru..."></textarea>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex items-center justify-center p-4 bg-slate-800/30 rounded-2xl border-2 border-transparent cursor-pointer transition-all hover:bg-emerald-500/5 has-[:checked]:border-emerald-500/50 has-[:checked]:bg-emerald-500/10 group">
                                <input type="radio" name="status" value="Diterima" class="hidden" checked onchange="toggleAlasan()">
                            ...
                            <label class="relative flex items-center justify-center p-4 bg-slate-800/30 rounded-2xl border-2 border-transparent cursor-pointer transition-all hover:bg-rose-500/5 has-[:checked]:border-rose-500/50 has-[:checked]:bg-rose-500/10 group">
                                <input type="radio" name="status" value="Ditolak" class="hidden" onchange="toggleAlasan()">
                                <div class="flex items-center space-x-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                <div id="alasan_diterima_group" class="animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <textarea name="alasan_diterima" rows="3" class="w-full px-5 py-4 bg-slate-800/50 rounded-2xl border border-slate-700 text-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none resize-none" placeholder="Tuliskan catatan atau alasan diterima..."></textarea>
                </div>
                <div id="alasan_ditolak_group" class="hidden animate-in fade-in slide-in-from-top-2 duration-300">
                    <label class="block text-[11px] font-black text-rose-400 uppercase tracking-widest mb-3 ml-1">Alasan Jika Ditolak</label>
                    <textarea name="alasan_ditolak" id="alasan_ditolak_field" rows="3" class="w-full px-5 py-4 bg-slate-800/50 rounded-2xl border border-slate-700 text-white focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all outline-none resize-none" placeholder="Berikan alasan penolakan..."></textarea>
                </div>
            </div>
